Contributing to Bitsex Core
============================

The Bitsex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitsex Core project, and is not to be
confused with overall Bitsex Network Protocol consensus changes.

Whether a pull request is merged into Bitsex Core rests with the project merge
...
Patches that change Bitsex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitsex consensus, it must have been
...
The project leader is the release manager for each Bitsex Core release.
