...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitsex features */
        {"bitsex", "masternode", &masternode, true, true, false},
        {"bitsex", "listmasternodes", &listmasternodes, true, true, false},
        {"bitsex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitsex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitsex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitsex", "masternodedebug", &masternodedebug, true, true, false},
        {"bitsex", "startmasternode", &startmasternode, true, true, false},
        {"bitsex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitsex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitsex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitsex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitsex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitsex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitsex", "mnbudget", &mnbudget, true, true, false},
        {"bitsex", "preparebudget", &preparebudget, true, true, false},
        {"bitsex", "submitbudget", &submitbudget, true, true, false},
        {"bitsex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitsex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitsex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitsex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitsex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitsex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitsex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitsex", "checkbudgets", &checkbudgets, true, true, false},
        {"bitsex", "mnsync", &mnsync, true, true, false},
        {"bitsex", "spork", &spork, true, true, false},
        {"bitsex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitsex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitsexd, or the -server option to bitsex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitsex-cli " + methodname + " " + args + "\n";
}
