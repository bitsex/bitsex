...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Bitsex is not connected
    ...
    RPC_WALLET_PASSBITSEXASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
