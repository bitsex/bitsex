                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitsex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitsex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitsex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitsex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitsex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitsex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitsex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitsex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bitsex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitsex Core help message to get a list with possible Bitsex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitsex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitsex network", "", count));
}
...
{
    QString strTitle = tr("Bitsex Core"); // default title
...
/** Creates context menu, its actions, and bitsexs up all the relevant signals for mouse events. */
