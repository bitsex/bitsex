...
/** Utility functions used by the Bitsex Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitsex addresses in monospace font
...
// Parse "bitsex:" URI into recipient object, return true on successful parsing
