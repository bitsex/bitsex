...
public:
    ...
    void setZBitsexControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBTSX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBTSX_clicked();
    void on_pushButtonZBitsexControl_clicked();
