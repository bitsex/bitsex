...
In order to support loading of multiple wallets in bitsex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitsex.cpp.
...
Changes to bitsex.cpp
----------------------
bitsex.cpp is the entry point into bitsex-qt, and as such, will require some minor modifications to provide hooks for
