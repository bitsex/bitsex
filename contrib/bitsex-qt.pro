...
RESOURCES += src/qt/bitsex.qrc src/qt/bitsex_locale.qrc

TRANSLATIONS += src/qt/locale/bitsex_bg.ts \
                src/qt/locale/bitsex_de.ts \
                src/qt/locale/bitsex_en.ts \
                src/qt/locale/bitsex_es.ts \
                src/qt/locale/bitsex_fi.ts \
                src/qt/locale/bitsex_fr.ts \
                src/qt/locale/bitsex_it.ts \
                src/qt/locale/bitsex_ja.ts \
                src/qt/locale/bitsex_pl.ts \
                src/qt/locale/bitsex_pt.ts \
                src/qt/locale/bitsex_ru.ts \
                src/qt/locale/bitsex_sk.ts \
                src/qt/locale/bitsex_sv.ts \
                src/qt/locale/bitsex_vi.ts \
                src/qt/locale/bitsex_zh_CN.ts \
                src/qt/locale/bitsex_zh_TW.ts
